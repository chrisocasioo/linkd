...
const FIELD_TYPES = [
  ...
  { id: 'cal',        label: 'Cal.com',    icon: 'time-outline' as const,           placeholder: 'cal.com/username',          keyboardType: 'url' as const },
  { id: 'acuity',     label: 'Acuity',     icon: 'calendar-clear-outline' as const, placeholder: 'yourname.as.me',            keyboardType: 'url' as const },
  { id: 'booksy',     label: 'Booksy',     icon: 'today-outline' as const,          placeholder: 'booksy.com/en-us/…',        keyboardType: 'url' as const },
